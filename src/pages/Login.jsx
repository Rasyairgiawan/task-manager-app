...
import { FaEnvelope, FaLock, FaSignInAlt, FaTasks, FaCheckCircle } from 'react-icons/fa';
...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex bg-gradient-to-br from-blue-600 via-purple-600 to-pink-500">
            {/* Left Side - Branding */}
            <div className="hidden lg:flex lg:w-1/2 bg-white bg-opacity-10 backdrop-blur-lg items-center justify-center p-12">
                <div className="text-white max-w-md">
                    ...
                    <h1 className="text-5xl font-bold mb-6">Task Manager Pro</h1>
                    <p className="text-xl mb-8 text-blue-100">
                        Organize your work and life, finally. Become focused, organized, and calm with the world's most powerful task management app.
                    </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-3">
                            <FaCheckCircle className="text-green-300 text-2xl" />
                            <span className="text-lg">Drag & drop interface</span>
                        </div>
                        <div className="flex items-center space-x-3">
                            <FaCheckCircle className="text-green-300 text-2xl" />
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-3 rounded-lg transition duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                            >
                                {loading ? (
